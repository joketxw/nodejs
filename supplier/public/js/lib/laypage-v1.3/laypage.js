...
/***此插件已被修改  如需使用 请另行下载  2016-12-12 by Neng.Gao ****/
; !
function() {
    "use strict";
    function a(d) {
...
/*    f.use = function(c, e) {
    ...
    f.prototype.view = function() {
        ...
        function() {
            return c.skip ? '<span class="laypage_total"><label>&#x5230;&#x7B2C;</label><input type="text" class="numEral" min="1" onkeyup="if(this.value>'+ c.pages +'){this.value='+ c.pages +'}" class="laypage_skip"><label>&#x9875;</label><input type="button" class="laypage_btn" value="确定">': ""
        } () + "</div>"
    },
