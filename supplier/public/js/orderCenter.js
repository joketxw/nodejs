                ...
                if(list.length!==0){
                    $(list).each(function (ix, dto) {
                        ...
                        if(dto.forderStatus==0){
                            ...
                            hml+='<p>待确认收货</p>';
                        }else if(dto.forderStatus==2){
                            hml+='<p>已完成</p>';
                        }
                        hml+='</div>';

                        if (dto.forderStatus==0&&((dto.fmoneyStatus==1&&dto.fpayStatus==2 )||(dto.fmoneyStatus==2&&dto.fpayStatus==1 )||(dto.fmoneyStatus==4&&fpayStatus==0))){
...
var click=function(){
    ...
    $('.classificationul li').click(function(){
        var fpayStatus=$(this).attr("fpayStatus");
        $(".classificationul li").removeClass("active");
        $(this).addClass('active');
        $('.payTypeBox li').removeClass('active');
    });
